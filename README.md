...
Financial data is collected or generated

Key features such as EMI ratio and income burden are computed

A machine learning model predicts stress level

The prediction is explained using interpretable techniques

The result can be extended to advisory and comparison use cases
